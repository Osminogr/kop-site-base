...
to {
  ...
  animation: ${eg} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,M=({toast:r})=>{let{icon:l,type:n,iconTheme:d}=r;return void 0!==l?"string"==typeof l?N.createElement(eb,null,l):l:"blank"===n?null:N.createElement(ef,null,N.createElement(eh,{...d}),"loading"!==n&&N.createElement(ex,null,"error"===n?N.createElement(ed,{...d}):N.createElement(ep,{...d})))},ye=r=>`
...
`,Ae=(r,l)=>{let n=r.includes("top")?1:-1,[d,c]=dist_b()?["0%{opacity:0;} 100%{opacity:1;}","0%{opacity:1;} 100%{opacity:0;}"]:[ye(n),ge(n)];return{animation:l?`${X(d)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${X(c)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},ev=N.memo(({toast:r,position:l,style:n,children:d})=>{let c=r.height?Ae(r.position||l||"top-center",r.visible):{opacity:0},h=N.createElement(M,{toast:r}),m=N.createElement(ew,{...r.ariaProps},T(r.message,r));return N.createElement(ey,{className:r.className,style:{...c,...n,...r.style}},"function"==typeof d?d({icon:h,message:m}):N.createElement(N.Fragment,null,h,m))});h=N.createElement,o.p=void 0,U=h,q=void 0,Q=void 0;var Ee=({id:r,className:l,style:n,onHeightUpdate:d,children:c})=>{let h=N.useCallback(l=>{if(l){let i=()=>{d(r,l.getBoundingClientRect().height)};i(),new MutationObserver(i).observe(l,{subtree:!0,childList:!0,characterData:!0})}},[r,d]);return N.createElement("div",{ref:h,className:l,style:n},c)},Re=(r,l)=>{let n=r.includes("top"),d=r.includes("center")?{justifyContent:"center"}:r.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:dist_b()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${l*(n?1:-1)}px)`,...n?{top:0}:{bottom:0},...d}},ej=goober_modern_u`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,Ie=({reverseOrder:r,position:l="top-center",toastOptions:n,gutter:d,children:c,containerStyle:h,containerClassName:m})=>{let{toasts:u,handlers:x}=D(n);return N.createElement("div",{style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...h},className:m,onMouseEnter:x.startPause,onMouseLeave:x.endPause},u.map(n=>{let h=n.position||l,m=Re(h,x.calculateOffset(n,{reverseOrder:r,gutter:d,defaultPosition:l}));return N.createElement(Ee,{id:n.id,key:n.id,onHeightUpdate:x.updateHeight,className:n.visible?ej:"",style:m},"custom"===n.type?T(n.message,n):c?c(n):N.createElement(ev,{toast:n,position:h}))}))},ToastContext=()=>(0,m.jsx)("div",{children:(0,m.jsx)(Ie,{position:"top-center",reverseOrder:!1})});function RootLayout(r){let{children:l}=r;return(0,m.jsx)("html",{lang:"en",suppressHydrationWarning:!0,children:(0,m.jsx)("body",{className:"dark:bg-black ".concat(x().className),children:(0,m.jsxs)($,{enableSystem:!1,attribute:"class",defaultTheme:"light",children:[(0,m.jsx)(components_Lines,{}),(0,m.jsx)(components_Header,{}),(0,m.jsx)(ToastContext,{}),l,(0,m.jsx)(components_Footer,{}),(0,m.jsx)(ScrollToTop,{})]})})})}},2853:function(){},5697:function(r){r.exports={style:{fontFamily:"'__Inter_c39ed5', '__Inter_Fallback_c39ed5'",fontStyle:"normal"},className:"__className_c39ed5"}},1396:function(r,l,n){r.exports=n(8326)},4033:function(r,l,n){r.exports=n(94)}},function(r){r.O(0,[413,280,326,971,472,744],function(){return r(r.s=9760)}),_N_E=r.O()}]);